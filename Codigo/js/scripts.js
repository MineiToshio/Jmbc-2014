...
var   window_height = $(window).height(),
	  ...
	  nameError = '<div class="alert-message error">Por favor escribe tu nombre.<span class="close" href="#">x</span></div>',
	  emailError = '<div class="alert-message error">Por favor escribe tu correo electrónico.<span class="close" href="#">x</span></div>',
	  invalidEmailError = '<div class="alert-message error">Por favor ingresa un correo electrónico válido.<span class="close" href="#">x</span></div>',	  
	  subjectError = '<div class="alert-message error">Por favor escribe un asunto.<span class="close" href="#">x</span></div>',
	  messageError = '<div class="alert-message error">Por favor ingrese el mensaje.<span class="close" href="#">x</span></div>',	
